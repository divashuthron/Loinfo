...
Dim LeftMenuCode : LeftMenuCode = "AppraisalHistory"
Dim LeftMenuName : LeftMenuName = "Home / 평가기준관리 / 평가기준 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "평가기준 히스토리"
Dim LogDivision	: LogDivision = "AppraisalHistory"
%>
...
Dim StrURL			: StrURL = "/AppraisalHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE (Division = 'Appraisal' "
SQL = SQL & vbCrLf & "OR Division = 'StudentRecord' "
SQL = SQL & vbCrLf & "OR Division = 'CSAT') "& strWhere
