...
<%
Dim objDB, SQL, AryHash, arrParams, AryHash2, arrParams2, AryHash3, arrParams3, intNum
...
Dim OldDrawRanking, TxtScore, ScoreTemp
...
Dim Ranking2 : Ranking2 = 0
Dim DrawRankingNum3, DrawRankingNum4
...
Function UnqualifiedStandard_Down(Check, AryStudentNumber, Score, count)		
	For DrawRankingNum2 = 0 To count
		'Response.write "체크 : " & Check & "<br>"
		'Response.write "수험번호 : " & AryStudentNumber(DrawRankingNum2) & "<br>"
		'Response.write "면접점수 : " & Score(DrawRankingNum2) & "<br>"
		...
		'Response.write "석차 : " & DrawRanking(DrawRankingNum2) & "<br>"
		'Response.write "<br>"
	Next
	...
	If Check Then
		...
		For DrawRankingNum = 0 To count
			If DrawRanking(DrawRankingNum) = 0 Then
				...
				'Response.write "면접점수 : " & Score(DrawRankingNum) & "<br>"
		...
		'	Response.write Score(DrawRankingNum) & " / "
		...
		'	Response.write ArrTxtStudentNumber(DrawRankingNum) & " / "
		'	Response.write Score(DrawRankingNum) & " / "
		'	Response.write "계산석차 : " & ArrTxtDrawRanking(DrawRankingNum) & " / "	
		'	Response.write "베이스석차 : " & DrawRanking(DrawRankingNum) & " / "
		'	Response.write count2 & " / "
		'	Response.write "<br>"
		'	Response.write "<br>"
		'Next
...
Function UnqualifiedStandard_Up(Check, AryStudentNumber, Score, count)		
	...
	If Check Then
		...
		'1칸씩밖에 교체가 안 되므로, 동점자있을 경우 추가로 해야 오름차순이 됨
		For DrawRankingNum2 = 0 To count2
			For StandardNum = 0 To count2 - 1
				For StandardNum2 = StandardNum + 1 To count2
					If Score(StandardNum) > Score(StandardNum2) Then
