...
if (not(IsE(SearchText2))) then
	...
	ElseIf SearchType2 = "6" Then	
		If SearchText2 = "1" Then 
			...
			strWhere = strWhere & "And A.CSATAgreement  = '1'  "
		ElseIf SearchText2 = "2" Then     	
			strWhere = strWhere & "And  (B.CSATRatio <> '0' )  "
			strWhere = strWhere & "And (A.CSATAgreement is null Or A.CSATAgreement  = '0' )  "
		Else
			strWhere = strWhere & "And B.StudentRecordRatio = '999' "
		End If
	'7번 수동입력 
...
SQL = SQL & vbCrLf & "		, a.DrawStandard, a.DrawMsg, a.ExtraPoint, a.InterviewerPoint, a.PracticalPoint "
SQL = SQL & vbCrLf & "		, a.Tel1, a.Tel2, a.Tel3, a.Email, a.ZipCode, a.Address1, a.Address2 "
...
'SQL = SQL & vbCrLf & "		-- 생기부 ---------------------------------------------------------------------------------------------- "
'SQL = SQL & vbCrLf & "		, c.StudentNumber as StuRecCheck "
'SQL = SQL & vbCrLf & "		, c.Cors_Code, c.Majr_cs11, c.Majr_cs12, c.Majr_cs21, c.Majr_cs22, c.Majr_cs31, c.Majr_cs32 "
SQL = SQL & vbCrLf & "		, c.StudentNumber as StuRecCheck "
SQL = SQL & vbCrLf & "		, c.StuRecCheck_1, c.StuRecCheck_2, c.StuRecCheck_3, c.StuRecCheck_4 "
SQL = SQL & vbCrLf & "		, c.CourseCode "
SQL = SQL & vbCrLf & "		, c.MajorClass_1_1, c.MajorClass_1_2 "
SQL = SQL & vbCrLf & "		, c.MajorClass_2_1, c.MajorClass_2_2 "
SQL = SQL & vbCrLf & "		, c.MajorClass_3_1, c.MajorClass_3_2 "
'SQL = SQL & vbCrLf & "		-- 수능 ------------------------------------------------------------------------------------------------ "
SQL = SQL & vbCrLf & "		, d.StudentNumber as CSATCheck "
'SQL = SQL & vbCrLf & "		-- 검정고시 -------------------------------------------------------------------------------------------- "
SQL = SQL & vbCrLf & "		, e.StudentNumber as QualCheck "
'SQL = SQL & vbCrLf & "		-- 코드명 추출 ----------------------------------------------------------------------------------------- "
...
'========================================================================
'SQL = SQL & vbCrLf & "	/* 생기부 (인적사항(단일), 교과성적(복수), 학사사항(복수), 출결사항(복수)) */"
SQL = SQL & vbCrLf & "	LEFT OUTER JOIN ( "
SQL = SQL & vbCrLf & "		SELECT "
SQL = SQL & vbCrLf & "			c_1.MYear, c_1.StudentNumber "
SQL = SQL & vbCrLf & "			, c_1.[인적사항] AS StuRecCheck_1 "
SQL = SQL & vbCrLf & "			, c_1.[교과성적] AS StuRecCheck_2 "
SQL = SQL & vbCrLf & "			, c_1.[학적사항] AS StuRecCheck_3 "
SQL = SQL & vbCrLf & "			, c_1.[출결사항] AS StuRecCheck_4 "
SQL = SQL & vbCrLf & "			, c_2.[고교과목코드] AS CourseCode "
SQL = SQL & vbCrLf & "			, c_2.[전공과정_1_1] AS MajorClass_1_1, c_2.[전공과정_1_2] AS MajorClass_1_2 "
SQL = SQL & vbCrLf & "			, c_2.[전공과정_2_1] AS MajorClass_2_1, c_2.[전공과정_2_2] AS MajorClass_2_2 "
SQL = SQL & vbCrLf & "			, c_2.[전공과정_3_1] AS MajorClass_3_1, c_2.[전공과정_3_2] AS MajorClass_3_2 "
SQL = SQL & vbCrLf & "		FROM ( "
SQL = SQL & vbCrLf & "			SELECT MYear, StudentNumber, TableType FROM ( "
SQL = SQL & vbCrLf & "				SELECT MYear, StudentNumber, '인적사항' AS TableType FROM [V_생기부_인적사항] GROUP BY MYear, StudentNumber "
SQL = SQL & vbCrLf & "				UNION ALL "
SQL = SQL & vbCrLf & "				SELECT MYear, StudentNumber, '교과성적' AS TableType FROM [V_생기부_교과성적] GROUP BY MYear, StudentNumber "
SQL = SQL & vbCrLf & "				UNION ALL "
SQL = SQL & vbCrLf & "				SELECT MYear, StudentNumber, '학적사항' AS TableType FROM [V_생기부_학적사항] GROUP BY MYear, StudentNumber "
SQL = SQL & vbCrLf & "				UNION ALL "
SQL = SQL & vbCrLf & "				SELECT MYear, StudentNumber, '출결사항' AS TableType FROM [V_생기부_출결사항] GROUP BY MYear, StudentNumber "
SQL = SQL & vbCrLf & "			) AS [생기부_UNION_ALL] "
SQL = SQL & vbCrLf & "		) AS [생기부] "
SQL = SQL & vbCrLf & "		PIVOT ( "
SQL = SQL & vbCrLf & "			COUNT(TableType) FOR TableType IN ( [인적사항], [교과성적], [학적사항], [출결사항] ) "
SQL = SQL & vbCrLf & "		) AS c_1 "
SQL = SQL & vbCrLf & "		LEFT OUTER JOIN [V_생기부_인적사항] AS c_2 "	'// 생기부 - 전공과정 (c_2) 가져오기 위해 인적사항 다시 JOIN
SQL = SQL & vbCrLf & "			ON c_1.Myear = c_2.Myear "
SQL = SQL & vbCrLf & "				AND c_1.StudentNumber = c_2.StudentNumber "
SQL = SQL & vbCrLf & "	) AS c "
SQL = SQL & vbCrLf & "		ON a.Myear = c.Myear "
SQL = SQL & vbCrLf & "			AND a.StudentNumber = c.StudentNumber "
'SQL = SQL & vbCrLf & "	LEFT OUTER JOIN ( "
'SQL = SQL & vbCrLf & "		SELECT "
'SQL = SQL & vbCrLf & "			a.StudentNumber "
'SQL = SQL & vbCrLf & "			, b.StudentRecordRatio "
'SQL = SQL & vbCrLf & "			, c.EXAM_NUMB as StdentRecord1, c.Cors_Code, c.Majr_cs11, c.Majr_cs12, c.Majr_cs21, c.Majr_cs22, c.Majr_cs31, c.Majr_cs32 "
'SQL = SQL & vbCrLf & "			, d.EXAM_NUMB as StdentRecord2 "
'SQL = SQL & vbCrLf & "			, e.EXAM_NUMB as StdentRecord3 "
'SQL = SQL & vbCrLf & "			, f.EXAM_NUMB as StdentRecord4 "
'SQL = SQL & vbCrLf & "		FROM ApplicationTable AS a "
'SQL = SQL & vbCrLf & "			LEFT OUTER JOIN AppraisalTable AS b "
...
'========================================================================
'SQL = SQL & vbCrLf & "	/* 수능(단일) */"
SQL = SQL & vbCrLf & "	LEFT OUTER JOIN [V_수능_성적] AS d "
SQL = SQL & vbCrLf & "		ON a.Myear = d.Myear "
SQL = SQL & vbCrLf & "			AND a.StudentNumber = d.StudentNumber "
'SQL = SQL & vbCrLf & "	LEFT OUTER JOIN ( "
'SQL = SQL & vbCrLf & "		SELECT "
'SQL = SQL & vbCrLf & "			a.StudentNumber, b.CSATRatio, c.EXAM_NUMB AS StdentRecord "
'SQL = SQL & vbCrLf & "		FROM ApplicationTable AS a "
'SQL = SQL & vbCrLf & "			LEFT OUTER JOIN AppraisalTable AS b "
'SQL = SQL & vbCrLf & "				ON (a.Myear = b.Myear AND a.SubjectCode = b.SubjectCode) "
...
'========================================================================
'SQL = SQL & vbCrLf & "	/* 검정고시 (복수) */"
SQL = SQL & vbCrLf & "	LEFT OUTER JOIN ( "
SQL = SQL & vbCrLf & "		SELECT Myear, StudentNumber FROM [V_검정고시_성적] GROUP BY Myear, StudentNumber "
SQL = SQL & vbCrLf & "	) AS e "
SQL = SQL & vbCrLf & "		ON a.Myear = e.Myear "
SQL = SQL & vbCrLf & "			AND a.StudentNumber = e.StudentNumber "
'SQL = SQL & vbCrLf & "	LEFT OUTER JOIN ( "
'SQL = SQL & vbCrLf & "		SELECT "
'SQL = SQL & vbCrLf & "			a.Qualification, a.StudentNumber, b.StudentRecordRatio, c.EXAM_NUMB AS StdentRecord "
'SQL = SQL & vbCrLf & "		FROM ApplicationTable AS a "
'SQL = SQL & vbCrLf & "			LEFT OUTER JOIN AppraisalTable AS b "
'SQL = SQL & vbCrLf & "				ON (a.Myear = b.Myear AND a.SubjectCode = b.SubjectCode) "
...
'SQL = SQL & vbCrLf & "				ON a.StudentNumber = c.EXAM_NUMB "
'SQL = SQL & vbCrLf & "		WHERE 1 = 1 "
'SQL = SQL & vbCrLf & "			AND (b.StudentRecordRatio IS NOT NULL OR b.StudentRecordRatio <> '' OR b.StudentRecordRatio <> '0') "		'// StudentRecordRatio 생기부 비율 입력 체크
'SQL = SQL & vbCrLf & "			AND c.EXAM_NUMB IS NOT NULL "
				...
				<div class="pad_5">
					<form id="ListForm" method="post">
						...
						<table id="dt_basic_none" class="table table-striped table-bordered table-hover margin_0" width="100%">
							...
							<tbody>
							<%
								Dim StudentRecordStr : StudentRecordStr = "-"
								Dim QualificationStr, CSATStr, ManualStr
								...
								If isArray(AryHash) Then								
									For i = StartNum to EndNum
										...
										'QualificationAreaCode, QualificationYear, Subject, Semester
										'UniversityName, AugScore, PerfectScore, Credit
										'Division1, Division2, Division3, Division4, HighDivision
										'RefundDivision, RefundAccountHolder, RefundBankCode, RefundAccount 
										'DrawStandard, DrawMsg, ExtraPoint, InterviewerPoint, PracticalPoint
										'Tel1, Tel2, Tel3, Email, ZipCode, Address1, Address2
										'StudentNameAgreement, StudentAgreement, StudentRecordAgreement, QualificationAgreement
										...
										'DocumentaryCheck1, DocumentaryCheck2, DocumentaryCheck3, DocumentaryCheck4
										'DocumentaryCheck5, DocumentaryCheck6, DocumentaryCheck7, DocumentaryCheck8
										'Document, DocumentMsg, Qualification, StudentRecordData, QualificationData, CSATData, Reslut
										'DocumentaryCheck21, DocumentaryCheck22, DocumentaryCheck23, DocumentaryCheck24
										'INPT_USID, INPT_DATE, INPT_ADDR, UPDT_USID, UPDT_DATE, UPDT_ADDR, InsertTime
										''-- 평가비율 -------------------------------------------------------------------------------------------
										'StudentRecordRatio, InterviewerRatio, PracticalRatio, CSATRatio
										'DrawStandard1, DrawStandard2, DrawStandard3, DrawStandard4, DrawStandard5
										'UnqualifiedStandard1, UnqualifiedStandard2, UnqualifiedStandard3, UnqualifiedStandard4, UnqualifiedStandard5
										'ExtraPoint1, ExtraPoint2, ExtraPoint3, ExtraPoint4, ExtraPoint5
										'Scholarship1, Scholarship2, Scholarship3, Scholarship4, Scholarship5
										'DocumentaryEvidence1, DocumentaryEvidence2, DocumentaryEvidence3, DocumentaryEvidence4, DocumentaryEvidence5
										''-- 생기부 ----------------------------------------------------------------------------------------------
										'StuRecCheck, StuRecCheck_1, StuRecCheck_2, StuRecCheck_3, StuRecCheck_4
										'CourseCode, MajorClass_1_1, MajorClass_1_2, MajorClass_2_1, MajorClass_2_2, MajorClass_3_1, MajorClass_3_2
										''-- 수능 ------------------------------------------------------------------------------------------------
										'CSATCheck
										''-- 검정고시 --------------------------------------------------------------------------------------------
										'QualCheck
										...
										'	StudentRecordStr = "-"
										'Else
										If AryHash(i).Item("StudentRecordRatio") <> 0 Then
										...
										Select case AryHash(i).Item("Semester")
											Case "1" : Semester = "MajorClass_1_1"
											Case "2" : Semester = "MajorClass_1_2"
											Case "3" : Semester = "MajorClass_2_1"
											Case "4" : Semester = "MajorClass_2_2"
											Case "5" : Semester = "MajorClass_3_1"
										End Select

										If AryHash(i).Item("Division1") = "X05041" Then '일반고전형
											If isnull(AryHash(i).Item("CourseCode")) Then
												DrawStandard = "Y"
												...
												End If
											Else
												If AryHash(i).Item("CourseCode") <> "0685" Then
													'일반고, 자율고가 아님
													DrawStandard = "Y"
													If isnull(DrawTemp) Then
													'If LEN(DrawMsg) < 1 Then
								...
								<tr class="viewDetail_SetDate_2">
									...
									<td>
										...
										<div class="DataField" style="display:none;">
											...
											<li Columnvalue="<%= Trim(AryHash(i).Item("CSATAgreement")) %>"						ColumnName="CSAT"></li>
