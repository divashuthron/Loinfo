...
Dim LogDivision				: LogDivision = "ReportExcels_R10"
...
Dim Division0 : Division0 = fnR("Division0","")
...
SQL = SQL & VbCrLf & "      , isnull((select count(StudentNumber) from ApplicationTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '31' and ReceiptDate = '2020-09-23'),0) / replace(isnull((select Sum(Quorum) from SubjectTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '31'),0),0,1) as 일반전형면접위주경쟁률"
...
SQL = SQL & VbCrLf & "      , isnull((select count(StudentNumber) from ApplicationTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '55' and ReceiptDate = '2020-09-23'),0) / replace(isnull((select Sum(Quorum) from SubjectTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '55'),0),0,1) as 특기자경쟁률"
...
SQL = SQL & VbCrLf & "      , isnull((select count(StudentNumber) from ApplicationTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '08' and ReceiptDate = '2020-09-23'),0) / replace(isnull((select Sum(Quorum) from SubjectTable where Subject = a.Subject and Division0 = a.Division0 and Division1 = '08'),0),0,1) as 농어촌경쟁률"
...
SQL = SQL & VbCrLf & "      , isnull((select count(StudentNumber) from ApplicationTable where Subject = a.Subject and Division0 = a.Division0 and ReceiptDate = '2020-09-23'),0) / replace(isnull((select Sum(Quorum) from SubjectTable where Subject = a.Subject and Division0 = a.Division0 ),0),0,1) as 합계경쟁률"

SQL = SQL & VbCrLf & "	from SubjectTable as a"
SQL = SQL & VbCrLf & "	where 1=1"
SQL = SQL & VbCrLf & "	--and a.InsertTime < '2020-09-23'"
SQL = SQL & VbCrLf & "	and a.Division0 = '"	& Division0 &	"'"
