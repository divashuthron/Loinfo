...
Dim LeftMenuCode : LeftMenuCode = "AssessmentHistory"
Dim LeftMenuName : LeftMenuName = "Home / 사정관리 / 사정 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "사정 히스토리"
%>
...
Dim StrURL			: StrURL = "/AssessmentHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE Division = 'AssessmentProc' " & strWhere
