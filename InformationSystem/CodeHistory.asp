...
Dim LeftMenuCode : LeftMenuCode = "CodeHistory"
Dim LeftMenuName : LeftMenuName = "Home / 코드관리 / 코드 등록 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "코드 등록 히스토리"
Dim LogDivision	: LogDivision = "CodeHistory"
%>
...
Dim StrURL			: StrURL = "/CodeHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE Division = 'code' " & strWhere
	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-title">
				<h5>검색정보<%Request.ServerVariables("URL")%></h5>
