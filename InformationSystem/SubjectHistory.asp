...
Dim LeftMenuCode : LeftMenuCode = "SubjectHistory"
Dim LeftMenuName : LeftMenuName = "Home / 모집단위관리 / 모집단위 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "모집단위 히스토리"
Dim LogDivision	: LogDivision = "SubjectHistory"
%>
...
Dim StrURL			: StrURL = "/SubjectHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE Division = 'Subject' " & strWhere
