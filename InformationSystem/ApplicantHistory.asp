...
Dim LeftMenuCode : LeftMenuCode = "ApplicantHistory"
Dim LeftMenuName : LeftMenuName = "Home / 지원자관리 / 지원자 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "지원자 히스토리"
Dim LogDivision	: LogDivision = "ApplicantHistory"
%>
...
Dim StrURL			: StrURL = "/ApplicantHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE (Division = 'ApplicantList' "
SQL = SQL & vbCrLf & "OR Division = 'StudentRecordAdd' "
SQL = SQL & vbCrLf & "OR Division = 'CSATAdd' "
SQL = SQL & vbCrLf & "OR Division = 'ApplicantAddList' "
SQL = SQL & vbCrLf & "OR Division = 'ApplicantProc') "& strWhere
