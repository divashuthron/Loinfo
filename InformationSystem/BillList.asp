...
Dim LeftMenuNameDetail : LeftMenuNameDetail = "고지서 조회-***차후 충원서버와 연동 예정"
%>
...
SQL = SQL & vbCrLf & "	IDX,MYear,Division0,dbo.getSubCodeName('Division0', Division0) AS DivisionName,Title,Degree,State "
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-title">
				...
				<div style="float:right;">
					<span class="btnBasic btnTypeAdd" id="btnREG">고지서 등록</span>
				</div>
			</div>
