...
Dim LeftMenuCode : LeftMenuCode = "Charts"
Dim LeftMenuName : LeftMenuName = "Home / 통계관리 / 사정현황표"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "사정현황표"
%>
...
SQL = ""
SQL = SQL & vbCrLf & " exec XTEB_OSC_Test.dbo.UP_RealtimeStatusReport "
...
SQL = ""
SQL = SQL & vbCrLf & " exec XTEB_OSC_Test.dbo.UP_RealtimeStatusReportOthers "
			...
			<div class="ibox-content">
				<div class="pad_5" style="height:700px;">
					<table id="dt_basic_none" class="table table-striped table-bordered table-hover margin_0" >
						...
						%>
							<tr>
								<td colspan="8" style="height:50px; vertical-align: middle;">환불서버, 충원서버에 모두 등록되어 있어야 정상 집계됩니다.</td>
							</tr>
						<%
							end if
						%>
