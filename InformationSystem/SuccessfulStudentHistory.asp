...
Dim LeftMenuCode : LeftMenuCode = "SuccessfulStudentHistory"
Dim LeftMenuName : LeftMenuName = "Home / 합격자발표관리 / 합격자 히스토리"
Dim LeftMenuNameDetail : LeftMenuNameDetail = "합격자 히스토리"
%>
...
Dim StrURL			: StrURL = "/SuccessfulStudentHistory.asp"
...
SQL = SQL & vbCrLf & "WHERE (Division = 'SuccessfulStudentList' "
SQL = SQL & vbCrLf & "Or Division = 'BillProc' "
SQL = SQL & vbCrLf & "Or Division = 'DemandsProc' "
SQL = SQL & vbCrLf & "Or Division = 'DrawStandingSet') "& strWhere
